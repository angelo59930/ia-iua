...
def load_data(filename):
    ...
    """
    # Define a mapping for months using abbreviated month names
    months = {
    ...
    with open(filename) as f:
        ...
        for row in reader:
            # Convert each row to the appropriate data types and append to evidence
            evidence.append([
            ...
            # Convert the label to 1 if Revenue is true, otherwise 0
