    ...
    def getSuccessors(self, state: Any):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                ...
                successors.append(((next_position, tuple(next_corners), tuple(next_visited_corners)), action, 1))
...
def cornersHeuristic(state: Any, problem: CornersProblem):
    ...
    # Initialize the total heuristic cost to zero
    total_heuristic = 0
    
    # Starting from the current position
    position = current_position

    # We will use the Manhattan distance to compute the heuristic
    while unvisited_corners:
        # Find the closest unvisited corner to the current position
        ...
        # Add the minimum distance to the heuristic
        total_heuristic += min_distance

        # Move to the closest corner
        position = closest_corner

        # Mark the closest corner as visited by removing it from unvisited corners
