...
def depthFirstSearch(problem: SearchProblem):
    ...
    while not stack.isEmpty():
        # Pop the current state and the actions to reach it
        state, actions = stack.pop()
        # If the state is the goal state
        if problem.isGoalState(state):
            # Return the actions to reach it
            return actions
        ...
        if state not in visited:
            ...
            for successor, action, _ in problem.getSuccessors(state):
                # Push the successor and the actions to reach it to the stack
...
def breadthFirstSearch(problem: SearchProblem):
    ...
    while not queue.isEmpty():
        ...
        if state not in visited:
            ...
            # For each successor of the state
            for successor, action, _ in problem.getSuccessors(state):
                # Push the successor and the actions to reach it to the queue
    ...
    while not priorityQueue.isEmpty():
        ...
        if state not in visited:
            ...
            for successor, action, cost in problem.getSuccessors(state):
                # Push the successor and the actions to reach it to the priority queue
